...
def main() -> None:
    ...
    check('Data-informed process control' in technology and 'workflow-description' in technology, "Accessible monitoring description missing", errors)
    check('workflow-illustration' not in css and 'workflow-monitoring-icon' not in css, "Obsolete cropped workflow styling remains", errors)
    ...
    check("Choose a defined capped + N1mΨ catalogue sequence" in services and "The listed catalogue mRNAs can be supplied" in services, "Catalogue-to-off-the-shelf ordering logic is unclear", errors)
